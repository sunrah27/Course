...
print(s1[10])
print(s1[12])
print(s1[50]) # throws error as the string length is only 24
...
#"Modify"
#"To Do: Complete the code below find method to find /locate substring substring 'are' within a given s4 variable "
print(s4.find("are"))
