...
# sort list items
listOfNums.sort()  # sort list in ascending order
print(listOfNums)

listOfNums.sort(reverse=True)  # sort list in descending order
print(listOfNums)

# clear list
listOfNums.clear()  # clear/ remove all list items
print(listOfNums)
