...
print(f"The ninth character is: {letterInName[8]}")
...
name = "Tim Jones"
position = ["first", "second", "third", "fourth", "fifth", "sixth", "seventh", "eighth", "ninth", "tenth", "eleventh", "twelveth", "thirteenth", "fourteenth", "fifteenth", "sixteenth", "seventeenth"]

for i, (char, pos) in enumerate(zip(name, position), start=1):
    print(f"The {pos} character is: {char}")
...
numberOfIteration = range(1, 11)
for variableName in numberOfIteration:
    print(variableName)
...
for variableName in range(1, 11):
    print(variableName)
...
myName = "Shanur Islam"
print(len(myName))
for i, (char,pos) in enumerate(zip(myName, position), start=1):
    print(f"The {pos} characetr is {char}")
