from pymongo import MongoClient # import the mongoclient from the pymongo library
...
client = MongoClient("mongodb+srv://admin-malik:MnaBang4L3310!@cluster0.tnhuv.mongodb.net/")

# client = MongoClient("mongodb+srv://DB1Admin:T34chL3mp10%21@cluster0.cuzzc.mongodb.net/")
# method 1
