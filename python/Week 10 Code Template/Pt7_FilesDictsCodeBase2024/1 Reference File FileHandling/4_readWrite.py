...
with open('Course/python/Week 10 Code Template/Pt7_FilesDictsCodeBase2024/shanurIslam.txt', 'r+') as myFilePath:
    print("Printing file content directly: ", myFilePath.read())
    myFilePath.seek(0)
    readContents = myFilePath.read()
    print("Reading the file content: ", readContents)
    contents = "\nThis is how you add text to a new line\nLook text in new line"
    myFilePath.write(contents)
    myFilePath.seek(0)
